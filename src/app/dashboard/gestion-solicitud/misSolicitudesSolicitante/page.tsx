...
import { obtenerMisSolicitudesSolicitante, type Solicitud } from "@/lib/solicitud/solicitudApi";
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Mis Solicitudes Registradas</h1>
